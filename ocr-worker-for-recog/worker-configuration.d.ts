/**
 * ocr-worker-for-recog/worker-configuration.d.ts
 * Auto-generated TypeScript type definitions for the Cloudflare Worker 
 * environment and bindings (e.g., the AI binding).
 * This ensures type safety when interacting with the Worker's environment.
 */
/* eslint-disable */
