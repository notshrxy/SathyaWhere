/**
 * pages/Components/Sign-In/PrismBG.tsx
 * High-performance WebGL background using OGL, featuring a 3D rotating 
 * prism with bloom, noise, and interactive hover effects.
 */
