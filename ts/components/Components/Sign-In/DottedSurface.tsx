/**
 * pages/Components/Sign-In/DottedSurface.tsx
 * Three.js-based 3D particle surface component that creates an 
 * animated, wave-like background for authentication pages.
 */
