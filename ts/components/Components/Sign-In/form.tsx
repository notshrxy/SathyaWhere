/**
 * pages/Components/Sign-In/form.tsx
 * Polished login card component featuring a custom canvas particle 
 * background, CSS-driven accent lines, and integrated auth forms.
 */
