/**
 * pages/Components/LP Comps/Star Border.tsx
 * A creative wrapper component that adds an animated, moving 'star' gradient 
 * border effect to any element.
 */
...
const StarBorder = <T extends React.ElementType = 'button'>({
  ...
  return (
    ...
    >
      ...
      ></div>
      <div className="relative z-1" style={{ background: 'transparent', border: 'none' }}>
        {children}
      </div>
    </Component>
  );
