/**
 * pages/Components/LP Comps/CurvedLoop.tsx
 * SVG-based marquee text component that flows along a quadratic Bézier curve.
 */
...
const CurvedLoop: FC<CurvedLoopProps> = ({
  ...
  const pathD = `M-240,40 Q760,${40 + curveAmount} 1640,40`;
  const viewBox = '-250 0 2080 120';
